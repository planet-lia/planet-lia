...
//
// export class PeriodicStorageMovementEntity implements GameEntity {
//     ENTITY_ID = "1";
//     PERIOD = 0.25; // in seconds
//
//     assetPath: string;
//     sprite: Sprite;
//
...
//     movementChanges = [
//         {"time": 1, "rotationVelocity": 30, "velocity": 50},
//         {"time": 4, "rotationVelocity": -30, "velocity": 50},
//         {"time": 8, "rotationVelocity": -30, "velocity": 0},
//     ];
//
...
//                 }
//             } else {
//                 // Store movement periodically just to have more samples
//                 if (this.prevTime + this.PERIOD < time) {
//                     this.replay.push(LinearSection.toDict(this.ENTITY_ID, stringify(TextureEntityAttribute.X), time, this.sprite.x));
//                     this.replay.push(LinearSection.toDict(this.ENTITY_ID, stringify(TextureEntityAttribute.Y), time, this.sprite.y));
//                     this.prevTime = time;
//                 }
